...
const images = [
    { file: 'screenshot.png', bgColor: '#9dd4a8' }, // green
    { file: 'question-tab.png', bgColor: '#9dd4a8' }, // green
    { file: 'yellow-theme.png', bgColor: '#e0cc3a' }, // yellow
    { file: 'pink-theme.png', bgColor: '#e8b0d0' } // pink
];
...
async function generate() {
    ...
    for (const img of images) {
        ...
        await element.screenshot({ 
            path: path.join(__dirname, 'assets', `mockup-${img.file}`),
